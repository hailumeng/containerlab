...
var kindnames = []string{"vr-c8000v", "vr-cisco_c8000v"}
...
func (s *vrc8000v) Init(cfg *types.NodeConfig, opts ...nodes.NodeOption) error {
	s.cfg = cfg
	for _, o := range opts {
		o(s)
	}
...
func (s *vrc8000v) Config() *types.NodeConfig { return s.cfg }

func (s *vrc8000v) PreDeploy(_, _, _ string) error {
	utils.CreateDirectory(s.cfg.LabDir, 0777)
	return loadStartupConfigFile(s.cfg)
}

func (s *vrc8000v) Deploy(ctx context.Context) error {
...
func (*vrc8000v) PostDeploy(_ context.Context, _ map[string]nodes.Node) error {
	return nil
}

func (s *vrc8000v) GetImages() map[string]string {
	return map[string]string{
		nodes.ImageKey: s.cfg.Image,
	}
}

func (*vrc8000v) Destroy(_ context.Context) error          { return nil }
func (s *vrc8000v) WithMgmtNet(mgmt *types.MgmtNet)        { s.mgmt = mgmt }
func (s *vrc8000v) WithRuntime(r runtime.ContainerRuntime) { s.runtime = r }
func (s *vrc8000v) GetRuntime() runtime.ContainerRuntime   { return s.runtime }

func (s *vrc8000v) Delete(ctx context.Context) error {
	return s.runtime.DeleteContainer(ctx, s.cfg.LongName)
}

func (s *vrc8000v) SaveConfig(_ context.Context) error {
