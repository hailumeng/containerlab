...
var kindnames = []string{"vr-cat9kv", "vr-cisco_cat9kv"}
...
func (s *vrcat9kv) Config() *types.NodeConfig { return s.cfg }

func (s *vrcat9kv) PreDeploy(_, _, _ string) error {
	utils.CreateDirectory(s.cfg.LabDir, 0777)
	return loadStartupConfigFile(s.cfg)
}

func (s *vrcat9kv) Deploy(ctx context.Context) error {
...
func (*vrcat9kv) PostDeploy(_ context.Context, _ map[string]nodes.Node) error {
	return nil
}

func (s *vrcat9kv) GetImages() map[string]string {
	return map[string]string{
		nodes.ImageKey: s.cfg.Image,
	}
}

func (*vrcat9kv) Destroy(_ context.Context) error          { return nil }
func (s *vrcat9kv) WithMgmtNet(mgmt *types.MgmtNet)        { s.mgmt = mgmt }
func (s *vrcat9kv) WithRuntime(r runtime.ContainerRuntime) { s.runtime = r }
func (s *vrcat9kv) GetRuntime() runtime.ContainerRuntime   { return s.runtime }

func (s *vrcat9kv) Delete(ctx context.Context) error {
	return s.runtime.DeleteContainer(ctx, s.cfg.LongName)
}

func (s *vrcat9kv) SaveConfig(_ context.Context) error {
